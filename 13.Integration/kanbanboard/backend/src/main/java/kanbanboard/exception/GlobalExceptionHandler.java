...
public class GlobalExceptionHandler {
  ...
  public String handlerNoHandlerFoundException(jakarta.servlet.http.HttpServletRequest request)
      throws Exception {
  ...
  public void handlerNoResourceFoundException(jakarta.servlet.http.HttpServletResponse response)
      throws Throwable {
  ...
  public String handler(jakarta.servlet.http.HttpServletRequest request, Exception e)
      throws Exception {
    // logging
